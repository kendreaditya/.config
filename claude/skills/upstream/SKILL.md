...
Copied someone else's skill, agent, or command into `~/.config/claude/`? This tracks
...
```bash
S=~/.config/claude/skills/upstream/scripts/upstream.sh
...
```bash
~/.config/claude/skills/upstream/scripts/upstream.sh list
```
