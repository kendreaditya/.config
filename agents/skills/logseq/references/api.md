...
Full method name list in `scripts/_known_methods.txt` (123 entries). Each appears in either `api.cljs` or `sdk/*.cljs`. Agent contract at `scripts/AGENT_CONTRACT.md`.
