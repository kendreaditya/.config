---
name: learn
description: "Turn something you just did, or a source you point at, into a reusable skill in ~/.config/agents/skills/. Use when the user says learn this, remember how to do this, make that a skill, turn this into a skill, save this workflow, or points at a repo, doc URL, PDF, or book and wants durable notes rather than a one-off answer. Triggers: 'learn', 'make this a skill', 'turn this into a skill', 'save this workflow', 'skill-ify this', 'remember how we did this'."
---
...
`~/.config/agents/skills/<name>/SKILL.md`, symlinked from `~/.claude/skills/`.
